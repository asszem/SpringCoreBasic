package xmlBasedContainerConfiguration.autowiring;
...
public class Autowiring_Demo {
	...
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"xmlBasedContainerConfiguration/autowiring/autowiringByName.xml");
		...
		context = new ClassPathXmlApplicationContext("xmlBasedContainerConfiguration/autowiring/autowiringByType.xml");

		System.out.println("\n3. Autowiring byType");
		owner = context.getBean("phoneOwnerAutowiringByType", PhoneOwner.class);
		owner.displayOwner();

		context = new ClassPathXmlApplicationContext("xmlBasedContainerConfiguration/autowiring/autowiringByConstructor.xml");
